...
export default function Umsetzungsplan() {
  ...
  if (loading || status === 'loading') {
    return (
      <BaseLayout>
        <Head>
          <title>Laden... | Wesner Software</title>
        </Head>
            ...
            {projectsList?.map((p) => (
              <Grid item xs={12} md={6} key={p.id}>
                <Card
                  ...
                  onClick={() => router.push(`/de/Umsetzungsplan?id=${p.id}`)}
                >
  ...
  if (!project) {
    return (
      <BaseLayout>
        <Head>
          <title>Fehler | Wesner Software</title>
        </Head>
        <Container maxWidth="sm" sx={{ py: 10, textAlign: 'center' }}>
          <Alert severity="warning" sx={{ mb: 3 }}>
            Projekt nicht gefunden oder Zugriff verweigert.
          </Alert>
          {!isLoggedIn && (
  ...
  return (
    <BaseLayout>
      <Head>
        <title>Projektplan | Wesner Software</title>
      </Head>
          ...
          >
            <Box>
              {isAdmin && (
                <Button
                  size="small"
                  onClick={() => router.push('/de/Umsetzungsplan')}
                  sx={{ mb: 1, p: 0, justifyContent: 'flex-start' }}
                >
              ...
              comments.map((msg) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {msg.author_name} (
                      {msg.author_role === 'admin' ? 'Admin' : 'Kunde'})
                    </Typography>
